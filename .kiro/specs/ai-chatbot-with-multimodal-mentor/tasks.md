...
- [ ] 8. RAG (Retrieval-Augmented Generation) 시스템 구현
- [ ] 8.1 벡터 임베딩 서비스 구현
  - 텍스트 임베딩 생성 서비스
  - 벡터 데이터베이스 연동
  - 문서 청크 임베딩 저장
...
- [ ] 13. 아티팩트 시스템 구현
- [ ] 13.1 아티팩트 생성 및 관리 API
  - 아티팩트 CRUD API 구현
  - 아티팩트 타입별 처리 로직
  - 아티팩트 메타데이터 관리
  - _Requirements: 12.1, 12.4_

- [ ] 13.2 아티팩트 표시 및 편집 컴포넌트
  - 코드 구문 강조 컴포넌트
  - 마크다운 렌더링 컴포넌트
  - 실시간 편집 기능
...
- [ ] 14. 대화 히스토리 관리 시스템 구현
- [ ] 14.1 히스토리 조회 및 관리 API
  - 대화 세션 목록 조회 API
  - 세션별 메시지 조회 API
  - 히스토리 검색 기능
